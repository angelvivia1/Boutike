...
class CatalogsControllerTest < ActionController::TestCase
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post :create, catalog: { description: @catalog.description, image: @catalog.image, price: @catalog.price }
    end
  ...
  test "should update catalog" do
    patch :update, id: @catalog, catalog: { description: @catalog.description, image: @catalog.image, price: @catalog.price }
    assert_redirected_to catalog_path(assigns(:catalog))
  end
