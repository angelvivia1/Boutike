...
class ProveedorsControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { city: @proveedor.city, email: @proveedor.email, name: @proveedor.name, neighborhood: @proveedor.neighborhood, phone: @proveedor.phone, product: @proveedor.product, street_number: @proveedor.street_number }
    end
  ...
  test "should update proveedor" do
    patch :update, id: @proveedor, proveedor: { city: @proveedor.city, email: @proveedor.email, name: @proveedor.name, neighborhood: @proveedor.neighborhood, phone: @proveedor.phone, product: @proveedor.product, street_number: @proveedor.street_number }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end
